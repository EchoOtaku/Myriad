...
try {
  run('Frontend capture, replacement, throttling and revocation', process.execPath,
    ['node_modules/tsx/dist/cli.mjs', '--test', 'src/features/merope/perception/*.test.ts'], join(root, 'frontend'))
