use crate::{CompanionPolicy, RuntimeState};
use serde::Serialize;
...
pub fn companion_fingerprint(input: &FingerprintInput<'_>) -> String {
...
mod tests {
    ...
    fn fingerprint_is_stable_and_sensitive_to_unread_count() {
        ...
        let first = companion_fingerprint(&FingerprintInput {
            runtime: &runtime,
            policy: &policy,
        ...
        let second = companion_fingerprint(&FingerprintInput {
            runtime: &runtime,
            policy: &policy,
