...
export default function RSSHubConfigComponent({
  ...
  const currentInstance = useMemo(() => 
    instances.find(i => i.id === selectedInstanceId) || instances.find(i => i.enabled) || instances[0],
                  ...
                  {showAddForm && (
                    ...
                    >
                      <div className="p-3 bg-orange-50 dark:bg-orange-900/20 border border-orange-200/50 dark:border-orange-700/50 rounded-lg space-y-2">
                        ...
                        />
                        <div className="flex items-center gap-2">
                          <label className="text-[11px] text-gray-500" htmlFor="new-priority-input">{t.brew.rsshubPriority}:</label>
                          <input
                        ...
                        >
                          {isEditing ? (
                            ...
                            <div className="space-y-2" onClick={(e) => e.stopPropagation()}>
                              ...
                              />
                              <div className="flex items-center gap-2">
                                <label className="text-[11px] text-gray-500" htmlFor="edit-priority-input">{t.brew.rsshubPriority}:</label>
                                <input
                            ...
                            <>
                              ...
                              <div className="grid grid-cols-4 gap-1.5 mb-1.5">
                                ...
                                <div className="p-1 rounded bg-gray-100 dark:bg-neutral-800">
                                  ...
                                  <div className="text-xs font-medium text-gray-700 dark:text-gray-300">{instance.success_rate.toFixed(0)}%</div>
                                </div>
                                <div className="p-1 rounded bg-gray-100 dark:bg-neutral-800">
            ...
            {extractedParams.map(param => (
              <div key={param.name} className="flex items-center gap-2">
                <span className="text-xs text-gray-500 dark:text-gray-400 w-20 flex-shrink-0 font-mono">
                  :{param.name}
                  {!param.required && <span className="text-gray-400 ml-1">({t.brew.rsshubOptional})</span>}
                </span>
                <input
                  type="text"
...
export { ROUTE_CATEGORIES_KEYS, POPULAR_ROUTES };
