                  ...
                  >
                    ...
                    {comment.selected_text && (
                      <div className={`px-4 py-2.5 ${isDark ? 'bg-white/5' : 'bg-black/[0.03]'} border-b ${currentTheme.border}`}>
                        ...
                        <p className={`text-sm ${currentTheme.text} line-clamp-2 leading-relaxed`}>"{comment.selected_text}"</p>
                      </div>
                    )}
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          {(comment.reply_count || 0) > 0 && (
                            ...
                            >
                              ...
                              {comment.reply_count}{t.brew.replyCountSuffix}
                            </button>
                          )}
                        </div>
                    ...
                    {replyingTo?.id === comment.id && (
                      <div className={`px-4 pb-4`}>
                        <p className={`text-xs ${currentTheme.secondary} mb-1.5`}>
                          {t.brew.replyTo} @{replyingTo.user_display_name || replyingTo.user_name || t.brew.anonymousUser}
                        </p>
                        <div className="flex items-center gap-2">
                          <input
                            type="text"
