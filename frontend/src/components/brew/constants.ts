 ...
 */
export const getIconUrl = (iconUrl: string | null): string | null => {
 ...
 * 提取摘要纯文本
 */
export const getPlainText = (html: string | null): string => {
  if (!html) return '';
 ...
 * 提取完整纯文本 - 用于短文判断和显示
 */
export const getFullPlainText = (html: string | null): string => {
  if (!html) return '';
 ...
 */
export const getBase64Info = (base64: string): { mime: string; ext: string } => {
 ...
 */
export const getSourceColor = (source: { theme_color?: string | null }): string => {
