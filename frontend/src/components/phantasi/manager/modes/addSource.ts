...
export function resolveAddSourceType(
  sourceType: AddSourceKind,
  enablePhantasiaiForRsshub: boolean,
): AddSourceKind {
  return sourceType === 'rsshub' && enablePhantasiaiForRsshub
    ? 'phantasiai'
    : sourceType
}
...
export function addSubmitLabelKey(
  sourceType: AddSourceKind,
): 'addLink' | 'addPhantasiai' | 'addRsshub' | 'addSubscription' {
