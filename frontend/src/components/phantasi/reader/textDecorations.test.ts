...
it('decorates text without removing media ancestors, preserving selection and loaded embed text', () => {
  const dom = new JSDOM(
    '<main><p>one <em>two</em></p><section><iframe></iframe></section><div class="phantasi-embed-card">loaded</div></main>',
  )
  ...
  applyTextDecorations(
    root,
    '<p>one <em><mark class="user-comment-highlight" data-comment-id="1">two</mark></em></p><section><iframe></iframe></section><div class="phantasi-embed-card">placeholder</div>',
  )
  ...
  assert.equal(root.querySelector('.phantasi-embed-card').textContent, 'loaded')
  ...
  applyTextDecorations(
    root,
    '<p>one <em>two</em></p><section><iframe></iframe></section><div class="phantasi-embed-card">placeholder</div>',
  )
