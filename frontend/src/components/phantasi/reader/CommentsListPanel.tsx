            ...
            >
              <div className="flex items-center gap-2">
                <button
                  ...
                  title={t.phantasi.closeCommentPanel}
                >
                  <X className="w-4 h-4" />
                </button>
                    ...
                    >
                      {comment.selected_text && (
                        ...
                        >
                          ...
                          >
                            {t.phantasi.originalExcerpt}
                            {unresolvedCommentIds.has(comment.id) && (
                              <span className="block mt-1" role="status">{t.phantasi.commentAnchorUnresolved}</span>
                            )}
                          </p>
                          <p
                        ...
                        <div className="px-4 pb-4">
                          ...
                          <div className="flex items-center gap-2">
                            <input
                              ...
                              placeholder={t.phantasi.writeYourReply}
