...
export default memo(
  ({
    ...
    const voiceTip = (voice: { id: number; description: string }) =>
      localizedVoiceDescription(t.phantasi, voice)

    return (
      // 常驻 DOM，避免切换时重挂 backdrop-blur。用 animate + pointerEvents，不卸载。
      <>
        <motion.aside
          data-phantasi-reader-controls
          ...
          >
            ...
            >
              ...
              <button
                ...
                title={t.phantasi.clickBackLongTop}
              ...
              {isAuthenticated && (
                <button
                  ...
                  title={item.is_starred ? t.phantasi.unstar : t.phantasi.starred}
                >
                  <Star
              ...
              {isPhantasiai && (isAdmin || item.has_ai_annotations) && (
                <button
                  ...
                  title={annotationsLoading ? `${t.phantasi.loading}...` : 'AI'}
                >
                  {annotationsLoading ? (
              ...
              {onEditNote && (
                <button
                  ...
                  aria-label={t.phantasi.noteEdit}
                >
            ...
            <AnimatePresence>
              {showToc && toc.length > 0 && (
                ...
                >
                  ...
                  >
                    {t.phantasi.tocTitle} ({toc.length})
                  </div>
                      ...
                      >
                        {annotationsLoading ? (
                          <div className="flex flex-col items-center gap-2">
                            ...
                            <p className="text-xs">{t.phantasi.analyzing}</p>
                          </div>
                        ) : (
                          <div className="flex flex-col items-center gap-2">
                            <Sparkles className="w-6 h-6 opacity-30" />
                            <p className="text-xs">{t.phantasi.noAnnotations}</p>
                            {isAdmin && (
                              <button
            ...
            <AnimatePresence>
              {showPodcastPlayer && podcastDialogues.length > 0 && (
                <motion.div
                  ...
                  className={`absolute left-full ${showPhantasiaiPanel || (showToc && toc.length > 0) ? 'top-[calc(100%+0.5rem)]' : 'top-0'} ml-2 w-80 overflow-hidden rounded-2xl border ${currentTheme.border} ${currentTheme.surface} flex flex-col`}
                ...
                >
                        ...
                        <button
                          ...
                          title={
                            cloudTtsLoading
                              ...
                              : cloudTtsAvailable
                                ? t.phantasi.cloudTts
                                : cloudTtsError || t.phantasi.cloudTtsUnavailable
                          }
                        >
                          {/* 加载环由下方状态行独担，按钮不再转圈。 */}
                  ...
                  {cloudTtsLoading && (
                    ...
                    >
                      <Spinner size="xs" color="current" />
                      <span>
                        {t.phantasi.loadingCloudVoice} {cloudTtsLoadProgress.loaded}
                          ...
                          voiceList.length > 0 && (
                            <>
                              ...
                              >
                                ...
                                >
                                  <span>{t.phantasi.hostAnchor}</span>
                                  {hostVoiceId ? (
                                    <span className="text-emerald-500">
                                      {voiceNameById.get(hostVoiceId)}
                                    </span>
                                  ) : (
                                    <span>{t.phantasi.defaultVoice}</span>
                                  )}
                                </div>
                                <div className="flex flex-wrap gap-1">
                                  ...
                                  {groupedVoices.ultraMale.map((voice) => (
                                    <button
                                      ...
                                      title={`${voiceTip(voice)}${t.phantasi.voiceSuperNaturalSuffix}`}
                                    >
                                      {voice.name}
                                      <span className="ml-1 opacity-70">
                                        {t.phantasi.superNatural}
                                      </span>
                                    </button>
                                  ))}
                                  {groupedVoices.llmMale.map((voice) => (
                                    <button
                                      ...
                                      title={`${voiceTip(voice)}${voice.emotion_support ? t.phantasi.voiceEmotionalSuffix : ''}`}
                                    >
                                      {voice.name}
                                      {voice.emotion_support && (
                                        <span className="ml-1 opacity-70">
                                          {t.phantasi.emotionalLabel}
                                        </span>
                                      )}
                                    </button>
                                  ))}
                              ...
                              >
                                <div
                                  className={`text-xs ${currentTheme.secondary} mb-1.5 flex items-center justify-between`}
                                >
                                  <span>{t.phantasi.guestLabel}</span>
                                  {guestVoiceId ? (
                                    <span className="text-emerald-500">
                                ...
                                {articleCache.voices.map((voice) => (
                                  ...
                                  >
                                    <button
                                      ...
                                      title={t.phantasi.switchToThisVoice}
                                    >
                                    ...
                                    <button
                                      ...
                                      title={t.phantasi.clearVoiceCache}
                                    >
                                      {clearingVoiceId === voice.voice_id ? (
                                        <Spinner size="xs" color="current" />
                                      ) : (
                          ...
                          return (
                            ...
                            >
                              <div className="flex items-start gap-2">
                                ...
                                >
                                  {isHostA ? t.phantasi.hostA : t.phantasi.hostB}
                                </span>
