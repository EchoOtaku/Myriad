            ...
            >
              ...
              {item.reading_time && (
                <span className="flex items-center gap-1.5">
                  ...
                  {format(t.phantasi.readingTime, { time: item.reading_time })}
                </span>
              )}
              {item.word_count && (
                <span>
                  {item.word_count.toLocaleString(locale)} {t.phantasi.wordCount}
                </span>
              )}
              <ReaderTopicField
                itemId={item.id}
                    ...
                    <div className="flex gap-4">
                      ...
                      >
                        ...
                        >
                          ...
                          {t.phantasi.prevArticle}
                        </div>
                        <div
                          className={`${currentTheme.text} font-medium truncate`}
                        >
                          {queueNav.prev?.title || t.phantasi.noMore}
                        </div>
                      </button>
                      <button
                        onClick={() => {
                      ...
                      >
                        ...
                        <div
                          className={`${currentTheme.text} font-medium truncate`}
                        >
                          {queueNav.next?.title || t.phantasi.noMore}
                        </div>
                      </button>
                    </div>
                  </div>
