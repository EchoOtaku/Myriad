...
const ActivityItem = memo(({ activity, index }: { activity: Activity; index: number }) => {
  ...
  return (
    <motion.div
      ...
      className="flex items-center gap-2 p-1.5 rounded-lg bg-white/40 dark:bg-gray-800/40 hover:bg-white/60 dark:hover:bg-gray-800/60 transition-colors cursor-pointer"
    >
