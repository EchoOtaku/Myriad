...
import { useCallback, useRef, useLayoutEffect, useEffect, useState, useMemo } from 'react';
...
// 工具函数：验证并修正高度值
const validateHeight = (height: number | null | undefined): number | null => {
...
// 工具函数：安全设置高度
const safeSetHeight = (island: HTMLElement, height: number | null | undefined): boolean => {
...
const getPaddingVertical = (island: HTMLElement | null): number => {
  if (!island) return 0;
  try {
