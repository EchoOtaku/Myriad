...
const buildGradientLayer = (isDark: boolean, easeProgress: number, isEnteringPhase: boolean) => {
...
const getBlurAmount = (easeProgress: number, isEnteringPhase: boolean) => (
      ...
      <div className="w-[90%] md:w-[60%] h-full flex flex-col justify-end items-start pl-2 md:pl-6 overflow-hidden pb-8">
        <AnimatePresence mode="popLayout">
          {visibleLines.map((line) => (
            ...
            >
              <p className="text-2xl md:text-4xl font-bold text-gray-900 dark:text-gray-100 leading-tight tracking-widest"
                 style={{ 
...
const parseComprehensiveReportToChapters = (analysis: any): StageChapter[] => {
  ...
  const styleFields = [
    ...
    'decorative_emojis', 'card_subtitle', 'key_metric',
    'background_elements', 'icon_image_url', 'icon_prompt'
  ];
