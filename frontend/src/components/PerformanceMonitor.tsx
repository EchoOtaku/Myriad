...
function installAnimationTracker() {
  ...
  ;(window as Window).requestAnimationFrame = function (
...
function getJsAnimationStats(): JsAnimationStats {
  ...
  const rafPerSecond =
    elapsed > 0 ? Math.round(animationTracker.rafCallCount / elapsed) : 0
  ...
  try {
    ...
    webAnimationsRunning = allAnimations.filter(
...
export default function PerformanceMonitor() {
  ...
  const scanAnimations = useCallback(() => {
    ...
    try {
      ...
      const transformElements_list = document.querySelectorAll(
        '[style*="transform"]',
      )
      const transitionElements_list = document.querySelectorAll(
        '[style*="transition"]',
      )
      const willChangeElements_list = document.querySelectorAll(
        '[style*="will-change"]',
      )
      ...
      for (
        let i = 0;
        i < Math.min(transformElements_list.length, maxPerType);
        i++
      ) {
      ...
      for (
        let i = 0;
        i < Math.min(transitionElements_list.length, maxPerType);
        i++
      ) {
      ...
      for (
        let i = 0;
        i < Math.min(willChangeElements_list.length, maxPerType);
        i++
      ) {
  ...
  const hasAnimationIssues =
    animationStats.expensiveAnimations.length > 0 || animationStats.infinite > 3
    ...
    >
      ...
      <div className="p-3">
        ...
        <div className="flex items-center gap-2 text-[10px] flex-wrap">
          ...
          <span
            className={
              resourceStats.active > 0 ? 'text-blue-400' : 'text-gray-500'
            }
          >
          ...
          <span
            className={
              animationStats.running > 0 ? 'text-cyan-400' : 'text-gray-500'
            }
          >
          ...
          <span
            className={
              animationStats.infinite > 0 ? 'text-purple-400' : 'text-gray-500'
            }
          >
      ...
      {isExpanded && (
        <div className="border-t border-white/10">
          ...
          <div className="flex border-b border-white/10">
            {(['overview', 'animations', 'js', 'layout'] as TabType[]).map(
              (tab) => (
                <button
                  key={tab}
              ...
              <>
                  ...
                  <div className="space-y-1.5 text-[11px]">
                    {metrics.memory && (
                      <div className="flex justify-between">
                        <span className="text-gray-400">内存:</span>
                        <span
                          className={getMemoryColor(metrics.memory.usedPercent)}
                        >
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-1.5 text-[10px]">
                    {Object.entries(resourceStats.queuedByPriority).map(
                      ([priority, count]) => (
                        <div
                          key={priority}
            ...
            {activeTab === 'animations' && (
              <>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-3 gap-1.5 text-[10px]">
                    ...
                    <div className="bg-white/5 rounded px-2 py-1.5 text-center">
                      ...
                      <div
                        className={
                          animationStats.willChangeElements > 10
                            ? 'text-yellow-400'
                            : 'text-gray-400'
                        }
                      >
                    ...
                    <div className="bg-white/5 rounded px-2 py-1.5 text-center">
                      ...
                      <div className="text-gray-400">
                        {animationStats.transformElements}
                      </div>
                    </div>
                  </div>
                </div>
                ...
                {animationStats.expensiveAnimations.length > 0 && (
                  <div>
                    <div className="font-bold mb-2 text-orange-400">
                      可能影响性能
                    </div>
                    <div className="space-y-1 text-[10px] max-h-25 overflow-y-auto">
                      {animationStats.expensiveAnimations.map((anim, i) => (
                        <div
                          key={i}
                          className="bg-orange-500/10 border border-orange-500/30 rounded px-2 py-1"
                        >
                          <div
                            className="text-orange-300 font-medium truncate"
                            title={anim.selector}
                          >
                            {anim.selector}
                          </div>
                ...
                <div>
                  <div className="font-bold mb-2 text-gray-300">
                    ...
                    {animationStats.cssAnimations.length > 0 &&
                      `(${animationStats.cssAnimations.length})`}
                  </div>
                  {animationStats.cssAnimations.length > 0 ? (
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-1.5">
                    <button
                      onClick={() =>
                        setHighlightAnimations(!highlightAnimations)
                      }
                ...
                <div>
                  ...
                  <div className="grid grid-cols-3 gap-1.5 text-[10px]">
                    ...
                    <div className="bg-white/5 rounded px-2 py-1.5 text-center">
                      ...
                      <div
                        className={
                          jsAnimationStats.rafCallsPerSecond > 120
                            ? 'text-orange-400 font-bold'
                            : 'text-gray-400'
                        }
                      >
                    ...
                    <div className="bg-white/5 rounded px-2 py-1.5 text-center">
                      ...
                      <div
                        className={
                          jsAnimationStats.webAnimationsRunning > 5
                            ? 'text-yellow-400 font-bold'
                            : 'text-green-400'
                        }
                      >
                    ...
                    <div className="bg-white/5 rounded px-2 py-1.5 text-center">
                      ...
                      <div
                        className={
                          jsAnimationStats.framerMotionElements > 5
                    ...
                    <div className="bg-white/5 rounded px-2 py-1.5 text-center col-span-2">
                      ...
                      <div
                        className={
                          jsAnimationStats.totalJsAnimations > 10
                            ? 'text-orange-400 font-bold'
                            : 'text-green-400'
                        }
                      >
                      ...
                      <div className="space-y-2">
                        <div className="grid grid-cols-3 gap-1.5 text-[10px]">
                          <div className="bg-white/5 rounded px-2 py-1.5 text-center">
                            ...
                            <div
                              className={
                                status.activeSlots >= status.maxConcurrent
                                  ? 'text-orange-400 font-bold'
                                  : 'text-cyan-400'
                              }
                            >
