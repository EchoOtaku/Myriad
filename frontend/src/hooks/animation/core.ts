...
import { Feature, PAGE_FEATURES, hasFeature, getFeatureList } from './pageFeatures';
...
function scheduleIdleRun() {
  if (_idleCallbackId !== null || _idleTasks.length === 0 || !_isPageVisible) return;
