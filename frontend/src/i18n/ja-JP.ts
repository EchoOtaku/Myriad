...
export const jaJP: TranslationKeys = {
  ...
  companion: {
    ...
    anime25dDebugDescription:
      '復刻プレイヤーを直接操作します。頭の向き、まばたき、口、腕、胸、レイヤー一覧。',
    anime25dHeadX: '頭 X',
    anime25dHeadY: '頭 Y',
    anime25dEyeL: '左目',
    anime25dEyeR: '右目',
    ...
    details: '詳細設定',
    detailsDescription:
      'Anime2.5DRig プレイヤーのデバッグ。普段は閉じたまま使えます。',
    motionPsd: 'レイヤー PSD',
    ...
    motionSpring: 'スプリング追従',
    motionRuntimeSignals: '実行時モーション信号',
    motionSignalLocked: 'ロック中',
    motionSignalOpen: '開放',
    motionReviewEnter: '大画面レビューを開く',
    motionReviewDescription:
      'Anime2.5DRig の呼吸、まばたき、口、髪をフルサイズで確認します。',
    motionReviewExit: 'ワークベンチに戻る',
    motionReviewPrevious: '前のアクション',
    motionReviewReplay: 'もう一度再生',
    motionReviewNext: '次のアクション',
    motionSecondary: '髪・アクセサリーの追従',
    motionBreathFrequency: '呼吸の速さ',
    motionBreathAmplitude: '呼吸の大きさ',
    motionBlinkInterval: 'まばたき間隔',
    motionSpringFrequency: 'ばね周波数',
    motionSpringDamping: 'ばね減衰',
    motionSpringResponse: '追従レスポンス',
    motionPreview: 'アクションフレーズのプレビュー',
    motionIntentGreet: '挨拶',
    motionIntentRespond: '返答',
    motionIntentQuestion: '疑問',
    motionIntentDelight: '喜び',
    motionIntentEmphasize: '強調',
    motionIntentNotify: '通知',
    motionPresetLibrary: 'すべてのアクションプリセット',
    motionPresetCount: '個の利用可能なアクション',
    motionPresetCommunication: 'コミュニケーション',
    motionPresetEmotion: '感情リアクション',
    motionPresetExpression: '表情',
    motionPresetAmbient: '待機・状態',
    motionPerformanceDemos: 'シーン演技 Demo',
    motionPerformanceDescription:
      '実アクションの重ね合わせ、予備、接触リズム、視線、表情、収めを含む演技です。',
    motionPerformanceGreeting: '対面の挨拶',
    motionPerformanceExplanation: '説明と応答',
    motionPerformanceCelebration: '喜びのお祝い',
    motionPerformanceThoughtful: '考えてから応答',
    motionPerformanceFarewell: '別れの挨拶',
    motionPerformanceEncouragement: '励ます',
    motionPerformanceApology: '心から謝る',
    motionPerformanceDiscovery: '発見して紹介',
    motionPerformancePlayful: '楽しいやり取り',
    motionPerformanceBeatUnit: '拍',
    motionPerformanceActionUnit: 'アクション',
    motionPerformanceProgress: 'シーン演技の進行',
    motionPerformanceComplete: '演技が完了しました',
    motionPhaseAnticipation: '予備',
    motionPhaseAction: '本動作',
    motionPhaseSettle: '収め',
    motionGenerationLab: 'モーション生成ラボ',
    motionGenerationDescription:
      '同じ意味の動作でも、キャラクター状態に応じてテンポ、強さ、重心、つなぎを変化させます。',
    motionRegenerateVariant: '新しいバリエーション',
    motionGeneratedTempo: 'テンポ',
    motionGeneratedAmplitude: '振幅',
    motionGeneratedFluidity: '滑らかさ',
    motionGeneratedPhrases: '生成モーションフレーズ Demo',
    motionPhraseWarmGreeting: '温かい挨拶',
    motionPhraseThoughtfulReply: '考えてから返答',
    motionPhraseLivelyExplanation: '快活な説明',
    motionReset: '初期値に戻す',
    motionSave: 'キャラクター設定を保存',
    motionSaving: '保存中…',
    motionSaved: '保存済み',
    motionTimeline: 'モーションタイムライン',
    motionTimelineDescription:
      'クリップとレイヤーを選び、その瞬間の位置を編集します。終わったらクリップを保存してください。',
    motionClip: 'クリップ',
    motionLayer: 'レイヤー',
    motionKeyframeCurrent: '{current} / {total} フレーム',
    motionKeyframeEmpty: 'レイヤーのあるクリップを選んでください。',
    motionTranslateX: '横移動',
    motionTranslateY: '縦移動',
    motionAuthorPresentation: '表情エンベロープを作成',
    motionAuthorPresentationDescription:
      'このクリップの表情意図から予備・頂点・収勢のキーを作ります。',
    motionPlayClip: 'クリップをプレビュー',
    motionStartDemo: 'アセット巡回を再生',
    motionStopDemo: 'Demo を停止',
    motionDemoNow: '再生中',
    motionKeyframes: 'キーフレーム',
    motionKeyframeTime: '時間（秒）',
    motionRotation: '回転',
    motionScaleX: '横スケール',
    motionScaleY: '縦スケール',
    motionAddKeyframe: 'キーフレームを追加',
    motionRemoveKeyframe: 'キーフレームを削除',
    motionSaveClips: 'モーションクリップを保存',
    motionRigDiagnostics: 'Rig 構造診断',
    motionRegression: 'ビジュアル回帰記録',
    motionBaseline: 'ベースラインフレーム',
    motionCandidate: '比較フレーム',
    motionCaptureBaseline: 'ベースラインを撮影',
    motionCompareFrame: '撮影して比較',
    motionMigrateRig: '旧 Rig を移行・補完',
    motionMigrating: '移行中…',
    motionMigrationComplete: 'Rig は最新です',
    motionPsdPreflight: 'レイヤー PSD を事前検証',
    motionPsdValidating: 'PSD を検証中…',
    motionPsdCommit: '検証済みリグを確定',
    motionNeedsCompiledRig:
      'モーション設定を保存する前に、レイヤー PSD を取り込んでください。',
    faceStage: 'Arael',
  ...
  life: {
    onboarding: {
      ...
      step4Title: 'キャラクター外観を確認',
      step4Lead: '確認済みの人設を、固定して再利用できる上半身デザインへ変換します。',
      step5Title: 'メイン立ち絵を生成',
      step5Lead: '確認済みの外観デザインから、最初の 3:4 上半身メイン立ち絵を生成します。',
      ...
      portraitContractHint:
        '正面向きの 3:4 上半身。髪全体を入れ、下胸またはハイウエストで切り、左右に袖か腕の一部を必ず表示します。脚は出さず、手は任意です。',
      portraitRequirements: '今回の立ち絵の追加要件',
