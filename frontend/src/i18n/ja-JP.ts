...
export const jaJP: TranslationKeys = {
  ...
  life: {
    onboarding: {
      ...
      aiDistilledMeta: 'Lite モデルが {count} 件の報告から抽出しました。',
      reportsButFallback:
        '{count} 件の報告は読めましたが、Lite 抽出が終わらず予備タグを出しています。',
      regenerateSeeds: '別のセット',
      regeneratingSeeds: '生成中',
      saveFirst: '先に設定を保存してください。',
      nameLabel: '呼び名',
      nameHint: '空なら対外は Arael のまま。シャッフルは上のタグと Lite を使います。',
      ...
      personaNotCompleteIncomplete:
        '完全な人設は作れませんでした。下書きのまま「別のセット」か手直しして続けてください。',
