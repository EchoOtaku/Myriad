...
export const jaJP: TranslationKeys = {
  ...
  arael: {
    ...
    heartbeatSaveFailed: '定時タスクを保存できませんでした。',
    heartbeatToggleFailed: '定時タスクのオン/オフを切り替えられませんでした。',
    heartbeatDeleteFailed: '定時タスクを削除できませんでした。',
    heartbeatLoadFailed: '定時タスクを読み込めませんでした。',
    skillsLoadFailed: 'スキル一覧を読み込めませんでした。',
    memoryLoadFailed: 'メモリを読み込めませんでした。',
    memorySaveFailed: 'そのメモリを保存できませんでした。',
    memoryDeleteFailed: 'そのメモリを削除できませんでした。',
    skillDeleteFailed: 'そのスキルを削除できませんでした。',
