...
export const jaJP: TranslationKeys = {
  ...
  companion: {
    ...
    visualRequirementsDescription:
      '髪型、衣装、配色、象徴的なアクセサリーを追加できます。3:4、正面上半身、明るい背景、両側の部分的な腕は固定です。',
    visualRequirementsPlaceholder:
      '例：ピンクのショートヘア、紫のセーラー服、星の髪飾り、紫の瞳',
    ...
    motionWorkbenchDescription:
      'まばたき、口の形、髪、呼吸、頭の向きをリアルタイムで確認します。手は PSD のポーズのままです。',
    essentials: '必要な設定',
    essentialsDescription:
      'メイン立ち絵、レイヤー PSD、ページ上で見える呼吸・まばたき・髪の追従。',
    details: '詳細設定',
    detailsDescription:
      'レビュー、スプリング、アクション庫、タイムライン、診断。普段は閉じたまま使います。',
    motionPsd: 'レイヤー PSD',
    ...
    motionReviewDescription:
      'シルエット、関節、表情、フォロースルーをフルサイズで確認します。',
