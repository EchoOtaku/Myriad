...
export const zhCN: TranslationKeys = {
  ...
  gamePresenceWidget: {
    ...
    publicOnlyHint:
      '仅使用公开数据，无需 Cookie。Xbox / PSN 完整数据需在服务端配置 OPENXBL_API_KEY / PSN_NPSSO。',
    save: '保存',
    close: '关闭',
    longPressHint: '长按设置',
    longPressToSetup: '长按配置公开 ID',
    notConfigured: '未配置',
    fetchFailed: '获取失败',
    playing: '正在玩',
    online: '在线',
    ...
    nowPlaying: '正在游玩',
    statusUnknown: '状态未知',
    noGameActivity: '当前没有公开的游戏活动',
    showcase: '角色展柜',
    showcaseEmpty: '展柜未公开或为空',
    accountId: '账号 ID',
    degraded: '部分数据不可用（服务端密钥未配置）',
  },
