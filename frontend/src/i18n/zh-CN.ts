...
export const zhCN: TranslationKeys = {
  ...
  config: {
    title: '系统配置',
    platforms: '数据平台',
    platformsDesc: '连接各数据源并同步；拖动排序决定报告页卡片顺序',
    configBackupTitle: '备份与恢复',
    configBackupDesc: '导出 / 导入整站设置，或恢复为默认值',
    dragToReorder: '按住拖动排序',
    showHelpDetails: '显示说明',
    showHelpDetailsDesc: '展开说明与指南',
    optionGuide: '选项指南',
    optionGuideHeading: '{title} · 选项指南',
    openOptionGuide: '打开「{title}」选项指南',
    optionGuideFooterHint: '以上说明帮助理解选项；修改后请按页面提示保存。',
    guideSectionWhat: '是什么',
    guideSectionChain: '会牵连什么',
    guideSectionFrontend: '哪里能看见',
    guideSectionNotes: '要注意',
    ...
    autoRefreshTitle: '刷新',
    autoRefreshDescription: '定时拉取已启用平台数据。',
    autoRefreshFrequencyDesc: '各平台会错开执行，避免同时请求外部服务',
    autoRefreshOff: '关闭',
    autoRefreshEveryHours: '每 {hours} 小时',
    autoRefreshSummary: '当前：{count} 个平台，每 {hours} 小时。',
    autoRefreshNoPlatforms: '当前：无已启用平台。',
    ...
    imageUploadHint: '可填写 URL，或上传本地图片（PNG/JPEG/WebP/GIF/SVG/ICO，≤512KB）',
    imageUploadTypeError: '请选择图片文件',
    imageUploadSizeError: '图片大小不能超过 512KB',
    ...
    // 网络代理配置
    advanced: '高级配置',
    advancedDesc: '出站代理、API 镜像、设置备份/恢复与危险操作',
    enableProxy: '启用网络代理',
    ...
    platformSetupBangumi1Desc: 'bgm.tv 个人主页上的用户名；公开收藏可只填此项。',
    ...
    platformSetupMal2Desc:
      'apiconfig 创建应用；不填则走公开 load.json。',
    ...
    domainChecklist: {
      ...
      backend_restart_for_cors: '重启后端（CORS）',
    },
    ...
    oauthSetupFillDesc: '将 Client ID / Secret（及 Discovery）填入下方表单并保存。',
    ...
    oauthSetupGithub3Desc: '创建后复制 Client ID，并 Generate 生成 Client Secret。',
    ...
    oauthSetupMicrosoft1Desc: 'Azure Portal → App registrations → New registration。',
    ...
    oauthSetupGitlab2Desc: 'Redirect URI 填下方回调，勾选 openid / email / profile。',
    oauthSetupGitlab3Title: '复制凭证',
    oauthSetupGitlab3Desc: '保存后复制 Application ID 与 Secret。',
    oauthSetupDiscord1Title: '打开 Discord 开发者后台',
    oauthSetupDiscord1Desc: 'Applications → New Application → OAuth2 → General。',
    ...
    oauthSetupAuthentik3Desc: '复制 Client ID、Client Secret 与完整 Discovery URL。',
    ...
    oauthSetupCustom2Desc: '在 IdP 后台将下方回调 URL 登记为合法 Redirect URI。',
    oauthSetupCustom3Title: '复制凭证',
    oauthSetupCustom3Desc: '从 IdP 控制台复制 Client ID / Secret 与 Discovery。',
  ...
  life: {
    onboarding: {
      ...
      visualsWaitingDesign: '人设外形仍在生成中，完成后即可出图（请勿以为页面卡住）',
      ...
      waitDesignForVisuals: '人设仍在后台完善外形描述，出图可稍后再试；其它配置不受影响。',
