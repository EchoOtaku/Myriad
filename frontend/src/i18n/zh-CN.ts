...
export const zhCN: TranslationKeys = {
  ...
  config: {
    ...
    testConnection: '测试连接',
    testFailed: '连接测试失败',
    enableVirtualPersona: '启用虚拟人设',
    virtualPersonaDesc: '根据个人数据生成虚拟人物设定',
    ...
    personaConfigTitle: '虚拟人设配置',
    personaConfigDesc: '配置虚拟人设图片生成服务',
    personaUsageTitle: '使用说明',
    personaUsageInfo: 'Pollinations AI：完全免费，响应快速，适合开发测试和快速迭代\nImaginePro：专业 Midjourney API，图片质量极高，适合生产环境（需付费订阅）\nAI 会根据你的数据生成独特的虚拟人设，点击首页右上角的圆形头像查看',
    pollinationsDescription: '完全免费，响应快速（<1秒），适合开发测试和快速迭代',
    imagineproDescription: '专业 Midjourney API，图片质量极高，适合生产环境（需付费订阅）',
    personaUsageDescription: 'AI 会根据你的数据生成独特的虚拟人设，点击首页右上角的圆形头像查看',
    pollinationsFree: '免费',
    imagineproMJ: 'MJ',
