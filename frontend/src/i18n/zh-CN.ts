...
export const zhCN: TranslationKeys = {
  ...
  config: {
    ...
    analytics: {
      ...
      eventsTitle: '事件埋点',
      eventsDesc: '业务事件次数与触达访客（如登录成功）；可在代码中 trackEvent 扩展',
      referrersTitle: '来源站点',
      referrersDesc: '外部 referrer 主机名汇总（不含站内跳转）',
      scopeLabel: '统计范围',
      timezoneHint: '日切分使用服务器进程本地时区（由主机/容器时钟与 TZ 决定，无固定偏移）',
      rangeAria: '统计时间范围',
      daysN: '{n} 天',
      refresh: '刷新',
      todayViews: '今日浏览',
      ...
      topCountries: '访问国家',
      topCountriesHint: '选定范围内访客最多的国家（前三展示；悬停查看完整明细）',
    ...
    forceRefreshFrontendCacheSuccess: '前端缓存已清空，页面即将刷新…',
    ...
    runtimeDiagnosticsDesc:
      '执行真实数据库、存储、服务器出口、版本与后台任务检查，并生成不包含凭据的诊断报告。',
    ...
    runtimeDiagnosticsLocationUnavailable: '无法通过直连 HTTPS 验证服务器出口位置',
