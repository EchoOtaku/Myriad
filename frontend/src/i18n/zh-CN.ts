...
export const zhCN: TranslationKeys = {
  ...
  config: {
    ...
    // Updater 区段
    updaterTitle: '更新管理',
    updaterDesc: '管理 Myriad 自托管实例的版本升级与回滚',
    updaterCurrentVersion: '运行版本',
    updaterUpdaterVersion: 'Updater 版本',
    updaterChannel: '通道',
    updaterMaintenance: '维护模式',
    updaterMaintenanceOn: '是',
    updaterMaintenanceOff: '否',
    updaterJobInFlight: '进行中任务',
    updaterLatestAvailable: '最新可用',
    updaterLastChecked: '上次检查',
    updaterUnknown: '未知',
    updaterNeverChecked: '尚未检查',
    updaterNotRecorded: '(未记录)',
    updaterNone: '无',
    updaterTransport: '请求通道',
    ...
    updaterChecking: '检查中…',
    updaterNoAvailable: '当前无可用更新',
    updaterReleaseVersion: '版本',
    updaterReleasedAt: '发布时间',
    updaterMinFromVersion: '可降级到',
    updaterMinFromUnlimited: '(无限制)',
    updaterMigrationEstimate: '迁移耗时估计',
    updaterRequiresUpdater: '需要 updater ≥',
    updaterImageDigests: '镜像 digest',
    updaterUpgradeTo: '升级到 {version}',
    updaterDispatching: '派发中…',
    updaterDispatched: '更新任务已派发: {jobId}',
    updaterJobInFlightWarn: '已有进行中任务，请等待完成后再触发。',
    ...
    updaterSnapshotsTitle: '可恢复快照',
    updaterNoSnapshots: '暂无快照',
    updaterSnapshotCreatedAt: '创建时间',
    updaterSnapshotSourceVersion: '源版本',
    updaterSnapshotSize: '大小',
    updaterRollback: '回滚',
    ...
    updaterSelfUpdateCmd: 'docker compose pull updater && docker compose up -d updater',
    ...
    updaterSelfUpdateHint: '或在宿主机手动执行：',
    ...
    updaterStatusAvailableDesc: '点击升级开始进入维护模式并替换镜像',
    updaterStatusUpdating: '正在升级',
    updaterStatusUpdatingDesc: '维护模式已启用，业务暂时不可访问',
    ...
    updaterGroupAdvancedDesc: '镜像 digest、请求通道切换、运维 fallback',
    updaterDetailsTitle: '详细信息',
    updaterStepLog: '执行步骤',
  ...
  federation: {
    ...
    invitePlaceholder: '输入 Actor URL 邀请成员',
    rings: '环网',
