...
export const enUS: TranslationKeys = {
  ...
  arael: {
    ...
    heartbeatSaveFailed: 'Could not save that scheduled task.',
    heartbeatToggleFailed: 'Could not toggle that scheduled task.',
    heartbeatDeleteFailed: 'Could not delete that scheduled task.',
    heartbeatLoadFailed: 'Could not load scheduled tasks.',
    skillsLoadFailed: 'Could not load skills.',
    memoryLoadFailed: 'Could not load memories.',
    memorySaveFailed: 'Could not save that memory.',
    memoryDeleteFailed: 'Could not delete that memory.',
    skillDeleteFailed: 'Could not delete that skill.',
