...
export const enUS: TranslationKeys = {
  ...
  life: {
    onboarding: {
      ...
      aiDistilledMeta: 'Distilled by the Lite model from {count} reports.',
      reportsButFallback:
        'Read {count} reports. Lite distillation did not finish, showing fallback tags.',
      regenerateSeeds: 'New set',
      regeneratingSeeds: 'Generating',
      saveFirst: 'Save settings first.',
      nameLabel: 'Name',
      nameHint: 'Leave blank to stay Arael. Shuffle uses Lite and the tags above.',
      ...
      personaNotCompleteIncomplete:
        'Full persona did not finish. This is a seed draft — retry or edit, then continue.',
