...
export const enUS: TranslationKeys = {
  ...
  companion: {
    ...
    visualRequirementsDescription:
      'Add hair, costume, palette, or signature accessory details. The system keeps the 3:4 front portrait, light background, and partial side arms locked.',
    visualRequirementsPlaceholder:
      'For example: short pink hair, violet sailor outfit, star hair clip, purple eyes',
    ...
    motionWorkbenchDescription:
      'Preview blinks, mouth shapes, hair, breathing, and head turns. Hands stay in the PSD pose.',
    essentials: 'Essentials',
    essentialsDescription:
      'Master portrait, layered PSD, and the breath, blink, and hair follow you see on the page.',
    details: 'Details',
    detailsDescription:
      'Review canvas, springs, action library, timeline, and diagnostics. Leave this closed unless you need it.',
    ...
    motionReviewDescription:
      'Inspect silhouettes, joints, expressions, and follow-through at full size.',
