...
export const enUS: TranslationKeys = {
  ...
  companion: {
    ...
    anime25dDebugDescription:
      'Drive the replicated player: head turn, blink, mouth, arms, chest, and layer inventory.',
    anime25dHeadX: 'Head X',
    anime25dHeadY: 'Head Y',
    anime25dEyeL: 'Left eye',
    anime25dEyeR: 'Right eye',
    anime25dMouth: 'Mouth',
    anime25dArmY: 'Arm height',
    anime25dArmPos: 'Arm swing',
    anime25dBust: 'Chest',
    anime25dLean: 'Lean',
    ...
    details: 'Details',
    detailsDescription:
      'Debug the Anime2.5DRig player. Leave this closed unless you need it.',
    ...
    motionSpring: 'Spring follow',
    motionRuntimeSignals: 'Runtime motion signals',
    motionSignalLocked: 'locked',
    motionSignalOpen: 'open',
    ...
    motionReviewPrevious: 'Previous action',
    motionReviewReplay: 'Replay action',
    motionReviewNext: 'Next action',
    motionSecondary: 'Hair and accessory follow-through',
    motionBreathFrequency: 'Breathing rate',
    motionBreathAmplitude: 'Breathing amplitude',
    motionBlinkInterval: 'Blink interval',
    motionSpringFrequency: 'Spring frequency',
    motionSpringDamping: 'Spring damping',
    motionSpringResponse: 'Follow response',
    motionPreview: 'Action phrase preview',
    motionIntentGreet: 'Greet',
    motionIntentRespond: 'Respond',
    motionIntentQuestion: 'Question',
    motionIntentDelight: 'Delight',
    motionIntentEmphasize: 'Emphasize',
    motionIntentNotify: 'Notify',
    motionPresetLibrary: 'All action presets',
    motionPresetCount: 'available actions',
    motionPresetCommunication: 'Communication',
    motionPresetEmotion: 'Emotion',
    motionPresetExpression: 'Facial expressions',
    motionPresetAmbient: 'Ambient and state',
    motionPerformanceDemos: 'Scene performances',
    motionPerformanceDescription:
      'Layered real actions with anticipation, overlap, contact rhythm, gaze, expression, and settle.',
    motionPerformanceGreeting: 'Meet and greet',
    motionPerformanceExplanation: 'Explain and respond',
    motionPerformanceCelebration: 'Celebrate',
    motionPerformanceThoughtful: 'Think, then answer',
    motionPerformanceFarewell: 'Farewell',
    motionPerformanceEncouragement: 'Encourage',
    motionPerformanceApology: 'Sincere apology',
    motionPerformanceDiscovery: 'Discover and present',
    motionPerformancePlayful: 'Playful interaction',
    motionPerformanceBeatUnit: 'beats',
    motionPerformanceActionUnit: 'actions',
    motionPerformanceProgress: 'Scene performance progress',
    motionPerformanceComplete: 'Performance complete',
    motionPhaseAnticipation: 'Anticipation',
    motionPhaseAction: 'Action',
    motionPhaseSettle: 'Settle',
    motionGenerationLab: 'Motion generation lab',
    motionGenerationDescription:
      'Each semantic action varies its timing, weight, balance, and handoff with character state.',
    motionRegenerateVariant: 'New variant',
    motionGeneratedTempo: 'Tempo',
    motionGeneratedAmplitude: 'Amplitude',
    motionGeneratedFluidity: 'Fluidity',
    motionGeneratedPhrases: 'Generated motion phrase demos',
    motionPhraseWarmGreeting: 'Warm greeting',
    motionPhraseThoughtfulReply: 'Thoughtful reply',
    motionPhraseLivelyExplanation: 'Lively explanation',
    motionReset: 'Reset defaults',
    motionSave: 'Save character profile',
    motionSaving: 'Saving…',
    motionSaved: 'Saved',
    motionTimeline: 'Motion timeline',
    motionTimelineDescription:
      'Pick a clip and a layer, then edit that layer at one moment. Save clips when you are done.',
    motionClip: 'Clip',
    motionLayer: 'Layer',
    motionKeyframeCurrent: 'Frame {current} / {total}',
    motionKeyframeEmpty: 'Choose a clip that has layers.',
    motionTranslateX: 'Move X',
    motionTranslateY: 'Move Y',
    motionAuthorPresentation: 'Author expression envelope',
    motionAuthorPresentationDescription:
      'Build anticipation, apex, and settle keys from this clip’s expression intent.',
    motionPlayClip: 'Preview clip',
    motionStartDemo: 'Run asset sweep',
    motionStopDemo: 'Stop demo',
    motionDemoNow: 'Now playing',
    motionKeyframes: 'Keyframes',
    motionKeyframeTime: 'Time (seconds)',
    motionRotation: 'Rotation',
    motionScaleX: 'Scale X',
    motionScaleY: 'Scale Y',
    motionAddKeyframe: 'Add keyframe',
    motionRemoveKeyframe: 'Remove keyframe',
    motionSaveClips: 'Save motion clips',
    motionRigDiagnostics: 'Rig structural diagnostics',
    motionRegression: 'Visual regression recorder',
    motionBaseline: 'Baseline frame',
    motionCandidate: 'Candidate frame',
    motionCaptureBaseline: 'Capture baseline',
    motionCompareFrame: 'Capture and compare',
    motionMigrateRig: 'Migrate and enrich legacy rig',
    motionMigrating: 'Migrating…',
    motionMigrationComplete: 'Rig is up to date',
    motionPsdPreflight: 'Preflight layered PSD',
    motionPsdValidating: 'Validating PSD…',
    motionPsdCommit: 'Commit preflighted rig',
    motionNeedsCompiledRig: 'Import a layered PSD before saving motion settings.',
    faceStage: 'Arael',
  ...
  life: {
    onboarding: {
      ...
      step4Title: 'Confirm character design',
      step4Lead: 'Turn the confirmed persona into a frozen, reusable upper-body visual design.',
      step5Title: 'Generate master portrait',
      step5Lead: 'Generate the first 3:4 upper-body master portrait from the confirmed visual design.',
      ...
      portraitContractHint:
        'Front-facing 3:4 upper body with complete hair, cropped at the lower chest or high waist. Sleeves or partial arms must enter both sides; no legs, and hands are optional.',
      portraitRequirements: 'Portrait refinements',
      ...
      portraitRequirementsPlaceholder:
        'e.g. soft frontal light, larger face, less space above the hair',
