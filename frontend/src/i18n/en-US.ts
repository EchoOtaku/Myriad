...
export const enUS: TranslationKeys = {
  ...
  config: {
    ...
    analytics: {
      ...
      eventsTitle: 'Events',
      eventsDesc:
        'Product events and unique users (e.g. login). Extend with trackEvent in code.',
    ...
    runtimeDiagnosticsDesc:
      'Run real database, storage, server-egress, version, and background-task checks, then export a credential-free diagnostic report.',
