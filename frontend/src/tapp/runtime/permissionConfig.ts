/**
 * speech / phantasiList / federation 须与 fixtures 及后端 TappPermission /
...
export const PERMISSION_MAP: ReadonlyMap<string, TappPermission | 'public'> =
  new Map([
    ...
    ['phantasiList.list', 'phantasi:read'],
    ['phantasiList.get', 'phantasi:read'],
    ['phantasiList.sources', 'phantasi:read'],
    ['phantasiList.categories', 'phantasi:read'],
    ['phantasiList.stats', 'phantasi:read'],
    ['phantasiList.discover', 'phantasi:manage'],
    ['phantasiList.exportOpml', 'phantasi:read'],

    ['phantasiList.markRead', 'phantasi:write'],
    ['phantasiList.markUnread', 'phantasi:write'],
    ['phantasiList.markAllRead', 'phantasi:write'],
    ['phantasiList.star', 'phantasi:write'],
    ['phantasiList.unstar', 'phantasi:write'],

    ['phantasiList.getComments', 'phantasi:read'],
    ['phantasiList.createComment', 'phantasi:commentWrite'],
    ['phantasiList.updateComment', 'phantasi:commentWrite'],
    ['phantasiList.deleteComment', 'phantasi:commentWrite'],
    ['phantasiList.getReplies', 'phantasi:read'],
    ['phantasiList.createReply', 'phantasi:commentWrite'],

    ['phantasiList.addSource', 'phantasi:manage'],
    ['phantasiList.updateSource', 'phantasi:manage'],
    ['phantasiList.deleteSource', 'phantasi:manage'],
    ['phantasiList.refreshSource', 'phantasi:manage'],
    ['phantasiList.importOpml', 'phantasi:manage'],
    ['phantasiList.createCategory', 'phantasi:manage'],
    ['phantasiList.deleteCategory', 'phantasi:manage'],
