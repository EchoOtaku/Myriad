...
`index.html`. Myriad keeps its own companion shell and asset transaction flow;
...
compiler, renderer, motion clocks, and companion UI.

## Mainline gap comparison

| Anime2.5DRig behavior                                                                                                                                                                                                 | Companion before this regression                                                                                                | Mainline gap                                                                                                                                |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------- |
...
| Uses a depth table plus head-relative parallax/shear for pseudo-3D turns                                                                                                                                              | Rotates/translates a head bone with no layer-depth separation                                                                   | Apply name-based head depth offsets without changing the companion UI into the upstream demo                                                |
