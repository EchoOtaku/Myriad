...
test('character imports require independent generated symbol-eye variants', () => {
  assert.equal(CHARACTER_ASSET_CONTRACT_VERSION, 5)
  assert.ok(
    CHARACTER_ASSET_REQUIRED_CAPABILITIES.includes('dizzy-eye-variant'),
  )
  assert.ok(
